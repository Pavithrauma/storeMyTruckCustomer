...
const WeeklyParking = ({ index, touched, }) => {
  ...
  // console.log(locations, "oooooooooooooo");
  ...
  const submitForm = async (event) => {
    ...
    try {
      ...
      Swal.fire({
        position: 'top-end',
        icon: 'success',
        title: 'Weekly parking enrolled successfully.',
        showConfirmButton: true,
        confirmButtonText: 'OK',
      });
  ...
  const handleStartDateChange = (date) => {
    ...
    // Automatically calculate the end date to be 7 days after start date
    if (date) {
      const calculatedEndDate = new Date(date.getTime() + 7 * 24 * 60 * 60 * 1000);
      setEndDate(calculatedEndDate);
      calculateTotalDays(date, calculatedEndDate); // Always 7 days
    }
  };
  ...
  const DaysList = async (startDate, endDate) => {
    ...
    let parkingTypeObjectId = '66a23985afd7ace00b1d43e6';
  ...
  const handleFocus = async (latitude, longitude) => {
    ...
    try {
      ...
      console.log(res, 'suiiiiii-weekly');
      if (res?.data?.success) {
  ...
  const Vehicletype = async (vehicle) => {
    let parkingTypeId = '66a23985afd7ace00b1d43e6';
          ...
          <div className="row pb-4">
            <div className="col-md-12">
              ...
              <Accordion>
                ...
                >
                  <Typography>
                    WEEKLY PARKING AGREEMENT - TERMS AND CONDITIONS (CLICK TO
                    EXPAND)
                  </Typography>
                </AccordionSummary>
                <AccordionDetails>
                        ...
                        <div className="col-md-4 col-sm-4">
                          <div className="form-group">
                            ...
                            <DatePicker
                              selected={endDate}
                              className="form-control required"
                              placeholderText="End date will be automatically set to 7 days after start date"
                              readOnly // End date is now read-only as it's automatically calculated
                              dateFormat="MM/dd/yyyy"
                            />
                             {/* {lastdateerror && (
                                <div className="invalid-feedback">
        ...
        Submit
                    ...
                    <div className="step">
                      ...
                      <div className="row">
                        <div className="col-md-6 col-sm-6">
                          <div className="form-group">
                            <label>Amount Due ($)<span>*</span></label>
                            <input
                              type="number"
                        ...
                        <div className="col-md-6 col-sm-6">
                          <div className="form-group">
                            <label>Convenience Fee 3%<span>*</span></label>
                            <input
                              type="number"
                          ...
                          <div className="col-md-12 mb-3">
                            <Accordion>
                              ...
                              <AccordionDetails>
                                ...
                                <FormControlLabel
                                  required
                                  control={<Switch checked={isAcknowledged.security} onChange={handleSwitchChange('security')} />}
                                  label="Required"
                                />
