...
const Parking = ({ index, touched, }) => {
  ...
  const [vehicles, setVehicles] = useState([
    {
      vehicleNumber: '', year: '', make: '', model: '', color: '', usdot: '', tag: '', otherIdentifyingInfo: ''
    },
  ]);
  ...
  useEffect(() => {
    Vehicletype(); // Call the function only once
  }, []);

  // Called whenever the dependencies change
  useEffect(() => {
    ...
    // Setting the parking date to today's date
    setparkingDate(new Date());

    // Call Amountdetails only if all dependencies are valid
    if (locationId && vehicleTypeId && vechicleCount && parkingTypeId) {
      Amountdetails();
    }

    // Handle focus only when this effect runs
    handleFocus();
  ...
  const vehicleValues = (field, index,value) => {
  ...
  const handleVehicleCountChange = (e) => {
    ...
    let newVehicles = {};
    setVehicles([]);
    newVehicles = Array.from({ length: value -1  }, () => ({
        year,
        make,
        model,
        tagno,
    ...
    console.log("Vehicles Load" + JSON.stringify(vehicles));   
    // Validate the value
  ...
  const fetchVehicleData = async (vehicleNumber,index) => {


    try {
      setLicenseData(vehicleNumber);
      let url = "https://vpic.nhtsa.dot.gov/api/vehicles/DecodeVIN/" + vehicleNumber;
      console.log("url" + url);
      ...
      const updatedVehicles = [...vehicles];      
      console.log("Vehicles: ", JSON.stringify(updatedVehicles));
      ...
      if (updatedVehicles) {
        ...
        setVehicles(updatedVehicles);
        console.log("updatedVehicles: ", JSON.stringify(updatedVehicles));
      }
    } catch (error) {
  ...
  //   setFieldValue(`vehicles[${index}].${field}`, value);
  //   console.log("Vehilce data " +JSON.stringify(vehicles))
  // };
                  ...
                  <Form id="quotation" noValidate>
                    ...
                    <div className="step">
                      <div className="row">
                        ...
                        <div className="col-md-6 col-sm-6">
                          <div className="form-group">
                            ...
                            <Field
                              ...
                              onChange={(e) => handleVehicleCountChange(e)}
                            />
                            <ErrorMessage
                        ...
                        <input
                          type="hidden"
                          name={`vehicles[${index}].selectvehicle`}
                          value={selectvehicle}
                        />
                                ...
                                <div key={index} className="row vehicle-details">
                                  ...
                                  <div className="form-group">
                                    ...
                                    <Field
                                      ...
                                      placeholder="Enter the license number"
                                      className={`form-control ${licenseError ? "is-invalid" : ""}`} // Show error styling if applicable
                                      onChange={(e) => fetchVehicleData(e.target.value, index)} // Pass the full event to the handler
                                    />
                                    {licenseError && (
                                      <div className="invalid-feedback">
                                        {licenseError}
                                    ...
                                    <ErrorMessage
                                      name={`vehicles[${index}].vehicleNumber`} // Correctly map to the FieldArray name
                                      component="div"
                                      className="invalid-feedback"
                                    />
                                  </div>
                                  ...
                                  <div className="col-md-4">
                                    <div className="form-group">
                                      ...
                                      />
                                      <ErrorMessage name={`vehicles[${index}].make`} component="div" className="invalid-feedback" />
                                    </div>
                                  </div>
                                  <div className="col-md-4">
                                    <div className="form-group">
                                      ...
                                      />
                                      <ErrorMessage name={`vehicles[${index}].model`} component="div" className="invalid-feedback" />
                                    </div>
                                  </div>
                                  <div className="col-md-4">
                                    <div className="form-group">
                                          ...
                                          <div className="col-md-4">
                                            <div className="form-group">
                                              ...
                                              <Field
                                                ...
                                                onChange={(e) => {
                                                  vehicleValues('tagno', index, e.target.value)
                                                }} 
                                              />
                                              <ErrorMessage
                                                name={`vehicles[${index}].tagno`}
                                            ...
                                            <>
                                              <div className="col-md-6">
                                                <div className="form-group">
                                                  ...
                                                  <Field
                                                    name={`vehicles[${index}].color`}
                                                    value={vehicles[index]?.color || ''}
                                                    className={`form-control ${touched.vehicles?.[0]?.color && errors.vehicles?.[0]?.color ? "is-invalid" : ""}`}
                                                    onChange={(e) => {
                                                      vehicleValues('color', index, e.target.value)
                                                    }}
                                                  // readOnly
                                                  />
                                                  <ErrorMessage name={`vehicles[${index}].color`} component="div" className="invalid-feedback" />
                                              ...
                                              <div className="col-md-6">
                                                <div className="form-group">
                                                  ...
                                                  <Field
                                                    name={`vehicles[${index}].trailerTagno`}
                                                className={`form-control ${touched.vehicles?.[index]?.trailerTagno &&
                                                      errors.vehicles?.[index]?.trailerTagno
                                                      ? 'is-invalid'
                                                      : ''
                                                      }`}
                                                    onChange={(e) => {
                                                      vehicleValues('trailerTagno', index, e.target.value)
                                                    }} 
                                                  />
                                                  <ErrorMessage
                                                name={`vehicles[${index}].trailerTagno`}
                                  ...
                                  {(selectvehicle === 'Car' || selectvehicle === 'Trailer Only' || selectvehicle === 'Box Truck' || selectvehicle === 'Other' )&& (
                                        <> 
                                        ...
                                        <>
                                          ...
                                          <div className="col-md-4">
                                            <div className="form-group">
                                              ...
                                              {/* Error message for the trailer length */}
                                          <ErrorMessage name={`vehicles[${index}].trailerLength`} component="div" className="invalid-feedback" />
                                            </div>
                                          </div>
                                          <div className="col-md-4">
                                            <div className="form-group">
                                  ...
                                  <div className="col-md-8">
                                    ...
                                    <button type="button" className="button-1" onClick={() => push({ yearMakeModel: '', color: '', usdot: '', companyNameOnTractor: '', vehicleNumber: '', vehicleType: '' })}>Add Another</button>
                                  </div>
                                </div>
                              ))}
